(function(S) {
	...
	function DataMapper(attr){
		...
		this.init = function(){
			...
			if(this.target.find('.left .offside').length == 0) this.target.find('.left').before('<input type="checkbox" id="hamburger" class="offside" checked="checked" data="test" /><label for="hamburger" class="offside b2-bg"><span class="nv">Toggle menu (if not visible)</span><div class="chevron"></div></label>');
